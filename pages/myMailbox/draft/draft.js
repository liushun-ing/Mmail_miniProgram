...
Page({
    ...
    async getMailList() {
        ...
        try {
            const res = await api.mail.getDraft(reqData);
            if(res.code == 2000) {
                let mailList = res.data.draftList;
    ...
    getDetail: function(e) {
        // console.log(e);
        wx.navigateTo({
          url: `/pages/myMailbox/draftDetail/draftDetail?emailId=${e.currentTarget.dataset.id}`,
        });
    },
